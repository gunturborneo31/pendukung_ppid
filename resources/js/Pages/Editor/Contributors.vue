        ...
        <table class="min-w-full text-sm" v-if="contributors.length">
          <thead class="bg-slate-50 border-b border-slate-100">
            <tr>
              ...
              <th class="text-left px-5 py-3.5 text-xs font-semibold text-slate-400 uppercase tracking-wide">OPD</th>
          ...
          <tbody class="divide-y divide-slate-50">
            <tr v-for="user in contributors" :key="user.id" class="hover:bg-slate-50 transition">
              ...
              <td class="px-5 py-3.5 text-slate-500 text-xs">{{ user.opd?.name ?? '-' }}</td>
              <td class="px-5 py-3.5">
